...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
      <div [class]="isFullscreen ? 'fixed inset-4 bg-gray-800 rounded-lg shadow-xl flex flex-col' : 'bg-gray-800 rounded-lg shadow-xl w-full max-w-lg flex flex-col'">
        <!-- Header -->
        ...
        <!-- Footer -->
        <div class="px-6 py-4 bg-gray-900 rounded-b-lg flex justify-end gap-3 flex-shrink-0">
